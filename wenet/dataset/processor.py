...
def detect_language(sample, limited_langs):
    ...
    if len(limited_langs) == 1:
        if  limited_langs[0] == 'ug':
            sample['lang'] = 'kk'
        else:
            sample['lang'] = limited_langs[0]
    else:
...
def decode_wav_new(sample):
    ...
    try:
        ...
        err_msg = 'Failed to open {}'.format(wav_file)
        raise UrlOpenError(err_msg) from ex
...
if __name__ == '__main__':
    sample = {"key": "N_F_10001_G1_task1_1_S00000", "wav": "/mnt/shareEEx/liuxiaokang/data/MSDM/labeled_data/20230605/Control/N_10001_F/N_F_10001_G1_task1_1.wav", "txt": "哎", "start": 2.7911617640003055, "end": 3.18}
    decode_wav(sample)