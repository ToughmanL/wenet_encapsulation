...
def compute_log_mel_spectrogram(data,
    ...
    for sample in data:
        ...
        sample['feat'] = feat
        # if feat.shape[1] != 128:
        #     print("feat: " + str(feat.shape) + ", key: " + sample['key'])
        yield sample
...
def padding(data):
    ...
    for sample in data:
        ...
        # for feat, key in zip(sorted_feats, sorted_keys):
        #     if feat.shape[1] != 128:
        #         print("feat: " + str(feat.shape) + ", key: " + key)
        ...
        tasks = ["transcribe" for i in order]
        langs = ["kk" for i in order]
